...
```{r tf_plot, echo = FALSE, eval = TRUE, fig.align = 'center'}
library('data.table')
library('ggplot2')
...
TF-IDF removes less than 1% of the words as only the top 100 are selected. Different ways of selecting the threslhold could be tested.
